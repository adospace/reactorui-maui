...
namespace MauiReactor
{
    ...
    public partial class IndicatorView<T> : TemplatedView<T>, IIndicatorView where T : Microsoft.Maui.Controls.IndicatorView, new()
    {
        ...
        public IndicatorView(Action<T?> componentRefAction)
    ...
    public partial class IndicatorView : IndicatorView<Microsoft.Maui.Controls.IndicatorView>
    {
        ...
        public IndicatorView(Action<Microsoft.Maui.Controls.IndicatorView?> componentRefAction)
            : base(componentRefAction)
        {
    ...
    public static partial class IndicatorViewExtensions
    {
        ...
        public static T IndicatorSize<T>(this T indicatorView, double indicatorSize, RxDoubleAnimation? customAnimation = null) where T : IIndicatorView
        {
