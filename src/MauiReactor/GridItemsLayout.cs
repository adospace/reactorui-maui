...
namespace MauiReactor
{
    ...
    public abstract partial class GridItemsLayout<T> : ItemsLayout<T>, IGridItemsLayout where T : Microsoft.Maui.Controls.GridItemsLayout, new()
    {
        ...
        protected GridItemsLayout(Action<T?> componentRefAction)
    ...
    public static partial class GridItemsLayoutExtensions
    {
        ...
        public static T VerticalItemSpacing<T>(this T gridItemsLayout, double verticalItemSpacing, RxDoubleAnimation? customAnimation = null) where T : IGridItemsLayout
        {
        ...
        public static T HorizontalItemSpacing<T>(this T gridItemsLayout, double horizontalItemSpacing, RxDoubleAnimation? customAnimation = null) where T : IGridItemsLayout
        {
