...
namespace MauiReactor.Shapes
{
    ...
    public sealed partial class Rectangle : Shapes.Shape<Microsoft.Maui.Controls.Shapes.Rectangle>, IRectangle
    {
        ...
        public Rectangle(Action<Microsoft.Maui.Controls.Shapes.Rectangle?> componentRefAction)
    ...
    public static partial class RectangleExtensions
    {
        ...
        public static T RadiusX<T>(this T rectangle, double radiusX, RxDoubleAnimation? customAnimation = null) where T : IRectangle
        {
        ...
        public static T RadiusX<T>(this T rectangle, Func<double> radiusXFunc) where T : IRectangle
        {
        ...
        public static T RadiusY<T>(this T rectangle, double radiusY, RxDoubleAnimation? customAnimation = null) where T : IRectangle
        {
        ...
        public static T RadiusY<T>(this T rectangle, Func<double> radiusYFunc) where T : IRectangle
        {
