...
namespace MauiReactor.Shapes
{
    ...
    public partial class LineGeometry<T> : Shapes.Geometry<T>, ILineGeometry where T : Microsoft.Maui.Controls.Shapes.LineGeometry, new()
    {
        ...
        public LineGeometry(Action<T?> componentRefAction)
    ...
    public partial class LineGeometry : LineGeometry<Microsoft.Maui.Controls.Shapes.LineGeometry>
    {
        ...
        public LineGeometry(Action<Microsoft.Maui.Controls.Shapes.LineGeometry?> componentRefAction)
            : base(componentRefAction)
        {
    ...
    public static partial class LineGeometryExtensions
    {
        ...
        public static T EndPoint<T>(this T lineGeometry, Microsoft.Maui.Graphics.Point endPoint, RxPointAnimation? customAnimation = null) where T : ILineGeometry
        {
