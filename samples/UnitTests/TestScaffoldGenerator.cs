...
{
    public static void ShouldBeIgnoringLineEndings(this string actual, string expected)
    {
...
class TestScaffoldGenerator
{
    ...
    public void TestPropAttributeGenerators()
    {
        ...
        generatorResult.GeneratedSources[1].SourceText.ToString().ShouldBeIgnoringLineEndings("""
            // <auto-generated />
            #nullable enable
            namespace MyCode
            {
    ...
    public void TestPropAttributeGeneratorsForGenericClassesSameName()
    {
        ...
        generatorResult.GeneratedSources[2].SourceText.ToString().ShouldBeIgnoringLineEndings("""
            // <auto-generated />
            #nullable enable
            namespace MyCode
            {
